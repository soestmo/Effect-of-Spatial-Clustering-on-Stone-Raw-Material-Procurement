...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if ticks > 0 [plot [richness] of turtle materialsources]"
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "plot-pen-reset\nif ticks > 0 [\nforeach distancefromsource plot\n]"
...
@#$#@#$#@
The effect of spatial clustering on stone raw material procurement model is implemented in Netlogo version 5.2.1.

This model was constructed by Simen Oestmo and Marco A. Janssen, Arizona State University, 2014.

Copyright (C) 2014 S. Oestmo and M.A. Janssen.
...
<experiments>
  <experiment name="experiment" repetitions="1000" runMetricsEveryStep="false">
    ...
    <metric>maxrichness</metric>
    <metric>freqrichness</metric>
    <metric>distancefromsource</metric>
    <metric>nomateriallist</metric>
    <enumeratedValueSet variable="materialsources">
      <value value="5000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prandom">
      <value value="0"/>
      <value value="0.0010"/>
      <value value="0.01"/>
      <value value="0.1"/>
    ...
    <enumeratedValueSet variable="randomwalk">
      <value value="&quot;equalchance&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="nrmaterials">
      <value value="&quot;20&quot;"/>
    </enumeratedValueSet>
  </experiment>
